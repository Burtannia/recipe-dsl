...
For conciesness I shalln't list all the laws regarding conditions, they are
the expected associativity, commutativity and distributivity of conjuction
and disjunction.
...
As you can see, QuickSpec discovered the expected properties regarding
\texttt{minutes} and \texttt{hours}. The interesting
laws are the final three. Quickspec is hinting at the commutativity of
\texttt{combine}. With our current implementation, this makes sense,
