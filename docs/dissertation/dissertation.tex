...
% Select meat, weight per person, cooking time accordingly
% Select two vegetables, boil them
% Add roast or boiled potatoes
% Add yorkshire pudding
% Select sauce to go with meat: cranberry, horseradish, mint sauce, apple sauce
...
\newpage
    ...
    \begin{thebibliography}{12}
        ...
        \bibitem{core}
        Simon Peyton Jones. Erlang Solutions. \textit{Into the Core -
        Squeezing Haskell into Nine Constructors}. September 14, 2016.
