...
\begin{lstlisting}
    ...
    cupOfTea :: Recipe
    cupOfTea = combine "mix" milk ((combine "place in" teabag (heat 100 water)) >>> wait 5)
\end{lstlisting}
...
"a DSL should capture the semantics of the domain and nothing more".

\subsection{Conditionals}

% combine used to be used on wait to mean doFor
% contracts-pp -> combinators have 1 job

% heat, heatAt, wait etc. extracted into conditionals
...
combinator would no doubt require more thought. There is also a lack of any combinator
which describes various types of chopping.
