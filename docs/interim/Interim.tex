...
\begin{document}
    ...
    Our set of combinators allow us to describe a recipe, but how do
    we actual perform a recipe? We need some way to represent the
    semantics of a recipe. Again if we can make these compositional
