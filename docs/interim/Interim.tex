...
\begin{document}
    ...
    %     \centering\small
    %         \begin{align*}
    %         E\llbracket \rrbracket : Recipe &\rightarrow Tree \: Action \\
    %         E\llbracket Ingredient \: s \rrbracket &= Node \: (Get \: (Ingredient \: s)) \: [] \\
    %         E\llbracket Heat \: t \: r \rrbracket &= Node \:(PlaceInHeat \: r) \:
    %             [Node \: (Preheat \: t) \: [], E\llbracket r \rrbracket]) \\
    %         E\llbracket Wait \: t \rrbracket &= Node \: (DoNothing \: t) \: [] \\
    %         E\llbracket Combine \: r1 \: r2 \rrbracket &=
    %             Node \: (Mix \: r1 \: r2) \: [E\llbracket r1 \rrbracket , E\llbracket r2 \rrbracket] \\
    %         E\llbracket Sequence \: r1 \: r2 \rrbracket &=
    %             Node \: (DoNothing \: 0) \: [E\llbracket r1 \rrbracket , E\llbracket r2 \rrbracket]
    %         \end{align*}
    %     \caption{Denotational semantics for expanding recipes.}
    % \end{figure}
